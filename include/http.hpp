...
public:
  ...
  HTTP & add_query_parameter ( const std::string & p_key, const std::string & p_value );
  ...
  HTTP & add_body_parameter ( const std::string & p_key, const std::string & p_value );
...
protected:
  ...
  // The Wrapper::create() must be used.
