...
Tested with:
|         | Suse 15 | Oracle 8.6 | Oracle 8.6 | Ubuntu 22.04| Ubuntu 24.04|
|---------|---------|------------|------------|-------------|-------------|
| g++     |         | 8.5.0      | 19.1.7     |             | 13.3.0      |
| clang   | 7.0.1   |            |            | 14.0.0      |             |
| libuv   | 1.44.2  | 1.41.1     | 1.41.1     | 1.43.0      | 1.48.0      |
| libcurl | 8.6.0   | 7.61.1     | 7.61.1     | 7.81.0      | 8.5.0       |
